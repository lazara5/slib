...
protected:
	static SPtr<spdlog::logger> initConsole(SPtr<Config> const& cfg, String const& name, UPtr<ConstIterator<SPtr<String>>> const& params);
	static SPtr<spdlog::logger> initRotating(SPtr<Config> const& cfg, String const& name, UPtr<ConstIterator<SPtr<String>>> const& params);
	static SPtr<spdlog::logger> initSyslog(SPtr<Config> const& cfg, String const& name, UPtr<ConstIterator<SPtr<String>>> const& params);
...
public:
	...
	static SPtr<String> getLogDir(SPtr<Config> const& cfg);

	static SPtr<String> _defaultLogConfig;

	static void staticInit(SPtr<Config> const& cfg, UPtr<ConstIterator<SPtr<String>>> const& params);
	static void staticInit(SPtr<Config> const& cfg, String const& name, SPtr<String> const& defaultValue = _defaultLogConfig);
